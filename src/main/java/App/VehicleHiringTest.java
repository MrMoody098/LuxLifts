...
// It should return false if the vehicle is not registered or is already on map
        public abstract boolean testAddToMap(String registrationNumber, Location location);
...
//Return false if vehicle not registered or has not been added to the map
        public abstract boolean testMoveVehicle(String registrationNumber, Location location);
...
// If vehicle is not registered or is not on map the method returns false.
        public abstract boolean testRemoveVehicle(String registrationNumber);
        // Return the location of vehicle specified by the reg number if it is registered and added to the map, null otherwise.
        public abstract Location testGetVehicleLoc(String registrationNumber);
...
//of the boundaries).
        public abstract List<String> testGetVehiclesInRange(Location location, int r);
    }
